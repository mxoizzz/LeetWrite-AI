    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Features</li>
            <li className="font-mono text-xs text-foreground/80">How It Works</li>
            <li className="font-mono text-xs text-foreground/80">Live Demo</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">AI SDK</li>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2025 LeetWrite. All rights reserved.
        </p>
