  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "PASTE ", highlight: false },
        { text: "THE URL", highlight: true },
      ],
      description: "Drop in the LeetCode problem link. Write less, we handle the context.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "PASTE YOUR ", highlight: false },
        { text: "SOLUTION", highlight: true },
      ],
      description: "Add your accepted code. Think in solutions, not formatting.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        ...
        { text: "DISCUSSION", highlight: true },
      ],
      description: "AI with purpose builds a structured, professional write-up in seconds.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "PUBLISH ", highlight: false },
        { text: "ANYWHERE", highlight: true },
      ],
      description: "Copy clean Markdown and publish with confidence to LeetCode.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">05 / Process</span>
